              ...
              {eventDetails?.youtubeUrl && (
                ...
                >
                  <Button 
                    variant="outline"
                    size="lg"
                    className="w-full h-12 text-sm font-semibold border-2 border-red-500 text-red-500 bg-transparent rounded-xl transition-all duration-300 hover:bg-red-500 hover:text-white hover:shadow-lg hover:shadow-red-500/25 hover:-translate-y-0.5"
                  >
